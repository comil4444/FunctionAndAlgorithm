...
public class AbstractFactoryDemo {
	...
	public static void main(String[] args) {
		...
		FactoryProducer.getFactory("color").getColor("orange").fill();

		FactoryProducer.getFactory("draw").getShape("circle").draw();
		FactoryProducer.getFactory("draw").getShape("rectangle").draw();
		FactoryProducer.getFactory("draw").getShape("square").draw();
	}
	...
	abstract static class AbstractFactory {
		...
		abstract Drawing getShape(String draw);
	}
	
	static class DrawingFactory extends AbstractFactory{
	...
	static class Square implements Drawing {
		@Override
		public void draw() {
			System.out.println("Drawing " + this.getClass().getSimpleName());
		}
	...
	static class Rectangle implements Drawing {
		@Override
		public void draw() {
			System.out.println("Drawing " + this.getClass().getSimpleName());
		}
	...
	static class Green implements Color {
		@Override
		public void fill() {
			System.out.println("fill " + this.getClass().getSimpleName());
		}
	}
